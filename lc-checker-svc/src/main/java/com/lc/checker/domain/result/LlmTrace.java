 ...
 * and {@code AgentStrategy}. Exposed on {@code /trace} so a reviewer can see the full
 * prompt, raw response, and latency/token accounting without re-running anything.
 *
