 ...
 *
 * <p>Each value carries its default HTTP status and its classification for the
 * {@code InvoiceExtractionOrchestrator}:
 * <ul>
 *   <li>{@link Classification#FALLBACK_CANDIDATE} — server-side failure; other enabled
 *       sources may still produce a usable result, and the row is persisted FAILED.</li>
